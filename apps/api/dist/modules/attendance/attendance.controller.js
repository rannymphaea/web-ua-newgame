...
let AttendanceController = class AttendanceController {
    ...
    async processAttendance(user, body) {
        return this.attendanceService.processAttendance(user.uid, body.tokenId, body.deviceFingerprint);
    }
    async getMyHistory(user, limit) {
        return this.attendanceService.getAttendanceHistory(user.uid, parseInt(limit) || 20);
    }
    async checkAttendance(user, eventId) {
...
], AttendanceController.prototype, "processAttendance", null);
__decorate([
